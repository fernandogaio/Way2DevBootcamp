...
namespace Way2DevBootcamp.API.Controllers {
    ...
    public class CategoriasController : ControllerBase {
        ...
        public async Task<IEnumerable<CategoriaViewModelOutput>> Get()
            => _mapper.Map<IEnumerable<CategoriaViewModelOutput>>(await _uow.Categorias.GetAll());
        ...
        public async Task<IActionResult> GetById(int id) {
            ...
            return Ok(_mapper.Map<CategoriaViewModelOutput>(categoria));
        }
    }
}