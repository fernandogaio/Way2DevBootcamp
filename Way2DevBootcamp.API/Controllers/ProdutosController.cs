...
namespace Way2DevBootcamp.API.Controllers {
    ...
    public class ProdutosController : ControllerBase {
        ...
        public async Task<IEnumerable<ProdutoViewModelOutput>> Get()
            => _mapper.Map<IEnumerable<ProdutoViewModelOutput>>(await _service.GetAll());
        ...
        public async Task<IActionResult> GetById(int id) {
            ...
            return Ok(_mapper.Map<ProdutoViewModelOutput>(produto));
        }
        ...
        public async Task<IActionResult> Create([FromBody] ProdutoViewModelInput produtoViewModelInput) {
            try {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Edit(int id, [FromBody] ProdutoViewModelInput produtoViewModel) {
            try {
